...
```{r}
cat("View this CV online with links at [_adamdsmith.me/cv_](http://adamdsmith.me/cv)")
# cat("[<i class='fas fa-download'></i> Download this CV as a PDF](https://github.com/adamdsmith/adamdsmith/static/cv/adamdsmith_cv.pdf)")
```
...
Source code on [github](https://github.com/adamdsmith/adamdsmith/static/cv).
